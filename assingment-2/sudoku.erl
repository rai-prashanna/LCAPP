...
%% Chalmers.
%%
%% It has been cleaned up a bit and modified by Kostis Sagonas,
%% Dave Clarke and then Georgios Panayiotou, who are thus responsible 
%% for any bug or problem that might exist; if you find any, please
%% report that to the teachers as soon as possible!
%% -------------------------------------------------------------------
%%
%% Write your name(s) and group number (if applicable) below:
%% Name(s): 
%% Group #:
%% 
-module(sudoku).
